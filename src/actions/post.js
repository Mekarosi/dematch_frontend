...
export const addComment = (postId, formData) => async dispatch => { 
    ...
    try {
        const res = await axios.post(`https://dematch202.onrender.com/api/posts/comment/${postId}`, formData, config)
...
export const deleteComment = (postId, commentId) => async dispatch => { 
    ...
    try {
        await axios.delete(`https://dematch202.onrender.com/api/posts/comment/${postId}/${commentId}`)
